...
@interface AWDPushKeepAliveSent : PBCodable <NSCopying> {
    struct { unsigned char timestamp : 1; unsigned char connectionType : 1; unsigned char currentGrowthStage : 1; unsigned char dualChannelState : 1; unsigned char keepAliveACKDuration : 1; unsigned char keepAliveVersion : 1; unsigned char lastKeepAliveInterval : 1; unsigned char linkQuality : 1; unsigned char nextKeepAliveInterval : 1; unsigned char timeSinceConnected : 1; unsigned char timeSinceLastKeepAlive : 1; unsigned char timeSinceLastSuccessfulKeepAlive : 1; } _has;
}
