...
@interface AWDPushReceived : PBCodable <NSCopying> {
    struct { unsigned char timestamp : 1; unsigned char connectionType : 1; unsigned char dualChannelState : 1; unsigned char isFromStorage : 1; unsigned char linkQuality : 1; unsigned char payloadSize : 1; unsigned char receiveOffset : 1; unsigned char wakeStatus : 1; } _has;
}
