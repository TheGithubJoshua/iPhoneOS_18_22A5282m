@class NSString, RTPlatform, HKHealthStore, _HKWorkoutObserver, RTDefaultsManager, RTDistanceCalculator, HKWorkoutClusterStore, HKObserverQuery;
...
@property (retain, nonatomic) HKObserverQuery *theNewWorkoutsQuery;
@property (nonatomic) BOOL receivedInitialNewWorkoutsQueryResponse;
@property (retain, nonatomic) RTDefaultsManager *defaultsManager;
@property (retain, nonatomic) RTPlatform *platform;
@property (retain, nonatomic) RTDistanceCalculator *distanceCalculator;
@property (nonatomic) BOOL listenForNewWorkoutsEnabled;
...
- (id)_getWorkoutDefaultEndDate;
- (id)_getWorkoutDefaultStartDate;
- (id)_getWorkoutDefaultTypes;
...
- (void)_listenForNewWorkouts;
- (void)_onNewWorkoutNotification;
...
- (id)initWithDefaultsManager:(id)a0 distanceCalculator:(id)a1 healthKitStore:(id)a2 platform:(id)a3 workoutClusterStore:(id)a4;
- (id)initWithDefaultsManager:(id)a0 distanceCalculator:(id)a1 platform:(id)a2;
- (void)onNewWorkoutNotification;
