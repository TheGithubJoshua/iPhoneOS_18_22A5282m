...
@interface CVAPortraitVideoPipeline_Impl : NSObject <CVADisparityPostprocessingVideoPipeline, CVAMattingVideoPipeline, CVAPortraitVideoPipeline> {
    ...
    struct unique_ptr<DisparityConversion, std::default_delete<DisparityConversion>> { struct __compressed_pair<DisparityConversion *, std::default_delete<DisparityConversion>> { struct DisparityConversion *__value_; } __ptr_; } _disparityConversion;
    struct unique_ptr<GeometricTransformation, std::default_delete<GeometricTransformation>> { struct __compressed_pair<GeometricTransformation *, std::default_delete<GeometricTransformation>> { struct GeometricTransformation *__value_; } __ptr_; } _disparityGeometricTransformation;
    struct unique_ptr<FocusStatsPostprocessing, std::default_delete<FocusStatsPostprocessing>> { struct __compressed_pair<FocusStatsPostprocessing *, std::default_delete<FocusStatsPostprocessing>> { struct FocusStatsPostprocessing *__value_; } __ptr_; } _focusStatsPostprocessing;
    struct unique_ptr<DisparityAutofocus, std::default_delete<DisparityAutofocus>> { struct __compressed_pair<DisparityAutofocus *, std::default_delete<DisparityAutofocus>> { struct DisparityAutofocus *__value_; } __ptr_; } _disparityAutofocus;
    struct unique_ptr<DisparityStatistics, std::default_delete<DisparityStatistics>> { struct __compressed_pair<DisparityStatistics *, std::default_delete<DisparityStatistics>> { struct DisparityStatistics *__value_; } __ptr_; } _disparityStatistics;
    struct unique_ptr<cva::FocusStateMachine, std::default_delete<cva::FocusStateMachine>> { struct __compressed_pair<cva::FocusStateMachine *, std::default_delete<cva::FocusStateMachine>> { struct FocusStateMachine *__value_; } __ptr_; } _focusStateMachine;
    struct unique_ptr<StageLightStateMachine, std::default_delete<StageLightStateMachine>> { struct __compressed_pair<StageLightStateMachine *, std::default_delete<StageLightStateMachine>> { struct StageLightStateMachine *__value_; } __ptr_; } _stageLightStateMachine;
    struct unique_ptr<SdofStateMachine, std::default_delete<SdofStateMachine>> { struct __compressed_pair<SdofStateMachine *, std::default_delete<SdofStateMachine>> { struct SdofStateMachine *__value_; } __ptr_; } _sdofIntensityStateMachine;
...
- (id)internal_extractMatteWithRequest:(id)a0 disparityPostprocessingResult:(id)a1 usePostprocessedDisparity:(BOOL)a2 dilateForegroundMask:(BOOL)a3 gravity:(struct CVAVector { double x0; double x1; double x2; })a4 transitionData:(const struct TransitionData { BOOL x0; } *)a5 isMattingNeeded:(BOOL)a6 mattingCompletionHandler:(id /* block */)a7 isFinalStage:(BOOL)a8 status:(int *)a9;
