@class BRCSyncOperationBackoffRatio, BRCItemID, CKOperationGroup, BRCSyncDownOperation, BRCSyncBudgetThrottle, BRCAccountSession, NSMutableArray, NSString, NSMutableSet, BRCThrottleBase, NSError, BRCFetchRecentAndFavoriteDocumentsOperation, NSArray, NSMutableDictionary, brc_task_tracker, BRCPQLConnection, NSMutableIndexSet, UMUserSyncTask, NSObject, BRCZoneRowID, BRCDeadlineSource, BRCServerZone, BRCThrottle, BRCCreateZoneAndSubscribeOperation, BRCSyncOperationThrottle, BRMangledID, NSDate, BRCSyncUpOperation;
