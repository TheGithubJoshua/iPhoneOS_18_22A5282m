...
@property (readonly, nonatomic) NSData *distortionWarperMesh;
@property (readonly, nonatomic) long long distortionWarperMeshWidth;
@property (readonly, nonatomic) long long distortionWarperMeshHeight;
...
- (id)getInternalCalib;
- (id)initWithInternalCalibration:(id)a0;
- (id)internalCalib;
