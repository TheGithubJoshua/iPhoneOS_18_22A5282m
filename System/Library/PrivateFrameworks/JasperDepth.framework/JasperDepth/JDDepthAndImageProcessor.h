...
@property (readonly, nonatomic) struct { void /* unknown type, empty encoding */ columns[4]; } pointCloudToImageTransform;
...
- (id)initWithPointCloudToImageTransform:(struct { void /* unknown type, empty encoding */ x0[4]; })a0 imageCameraCalibration:(id)a1;
