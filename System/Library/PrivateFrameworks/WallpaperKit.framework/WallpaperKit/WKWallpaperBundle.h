@class NADescriptionBuilder, NSMutableDictionary, NAIdentity, UIImage, NSURL, NSString;
...
+ (id)_createWallpaperBundleInDirectory:(id)a0 version:(long long)a1 identifier:(long long)a2 name:(id)a3 family:(id)a4 disableParallax:(BOOL)a5 isOffloaded:(BOOL)a6 logicalScreenClass:(id)a7 thumbnailImageURL:(id)a8 assetMapping:(id)a9;

- (id)_colorWallpaperWithMetadataDictionary:(id)a0 wallpaperAppearance:(id)a1;
