@class NSString, BLSBacklightChangeEvent, NSHashTable, BLSHOnSystemSleepAction;
...
- (void)eventPerformer:(id)a0 didUpdateDisplayStateForState:(long long)a1 forEvent:(id)a2;
- (void)registerHandlersForService:(id)a0;
- (void).cxx_destruct;
- (void)systemSleepAction:(id)a0 systemWillWakeForReason:(id)a1;
- (void)eventPerformer:(id)a0 willUpdateDisplayStateForState:(long long)a1 forEvent:(id)a2;
- (void)systemSleepAction:(id)a0 performWithCompletion:(id /* block */)a1;
- (void)backlight:(id)a0 didCompleteUpdateToFlipbookState:(long long)a1 forEvent:(id)a2;
- (void)platformProvider:(id)a0 didChangeAlwaysOnSetting:(BOOL)a1;
- (void)eventPerformer:(id)a0 didUpdateVisualContentsToBeginTransitionToState:(long long)a1 forEvent:(id)a2;
- (void)dealloc;
