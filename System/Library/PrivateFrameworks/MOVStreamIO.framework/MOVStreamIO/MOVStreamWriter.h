...
@interface MOVStreamWriter : NSObject <VideoEncoderInterfaceDelegate, MOVStreamWriterStateContext, MOVStreamWriterDeprecated, MOVStreamWriterDeprecationNominates> {
    ...
    struct map<std::string, CMTime, std::less<std::string>, std::allocator<std::pair<const std::string, CMTime>>> { struct __tree<std::__value_type<std::string, CMTime>, std::__map_value_compare<std::string, std::__value_type<std::string, CMTime>, std::less<std::string>, true>, std::allocator<std::__value_type<std::string, CMTime>>> { void *__begin_node_; struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<std::string, CMTime>, void *>>> { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __value_; } __pair1_; struct __compressed_pair<unsigned long, std::__map_value_compare<std::string, std::__value_type<std::string, CMTime>, std::less<std::string>, true>> { unsigned long long __value_; } __pair3_; } __tree_; } m_lastPtsForStream;
...
- (void)addTrackForStreamWithIdentifier:(id)a0 formatDescription:(const struct opaqueCMFormatDescription { } *)a1 recordingConfiguration:(id)a2;
...
- (void)addMetadataTrack:(id)a0 formatDescription:(const struct opaqueCMFormatDescription { } *)a1;
...
- (const struct opaqueCMFormatDescription { } *)createMetadataFormatDescription:(id)a0;
