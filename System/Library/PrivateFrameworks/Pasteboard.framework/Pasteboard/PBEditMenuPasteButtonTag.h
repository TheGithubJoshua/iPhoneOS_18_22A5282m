...
@property (readonly) struct CGPoint { double x; double y; } contentOrigin;
...
- (id)initWithSecureName:(unsigned int)a0 size:(struct CGSize { double x0; double x1; })a1 contentOrigin:(struct CGPoint { double x0; double x1; })a2 displayMode:(unsigned long long)a3;
