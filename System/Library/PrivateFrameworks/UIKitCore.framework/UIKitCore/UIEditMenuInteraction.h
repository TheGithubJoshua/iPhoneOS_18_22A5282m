...
@protocol UIMenuLeaf, UIEditMenuInteractionDelegate;
...
@interface UIEditMenuInteraction : NSObject <UIContextMenuInteractionDelegate_ForWebKitOnly, UIContextMenuInteractionDelegate_Private, _UIContextMenuInteractionDelegateInternal, UIDeferredMenuElementDelegate, _UIEditMenuPresentationDelegate, UIInteraction_Internal, UIInteraction> {
    struct { unsigned char menuForSuggestedActions : 1; unsigned char targetRectForConfiguration : 1; unsigned char willPresentAnimator : 1; unsigned char willDismissAnimator : 1; unsigned char asyncMenuForSuggestedActions : 1; unsigned char didTransition : 1; unsigned char titleView : 1; unsigned char firstResponderTarget : 1; } _delegateImplements;
...
- (id)_editMenuPresentation:(id)a0 preparedMenuForDisplay:(id)a1;
...
- (BOOL)_shouldEnforceMenuControllerLifecycleForEditMenuPresentation:(id)a0;
- (void).cxx_destruct;
- (void)_editMenuPresentation:(id)a0 didSelectMenuLeaf:(id)a1;
