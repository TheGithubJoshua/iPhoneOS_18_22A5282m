@class NSString, _UIFocusUpdateRequest, NSTimer, UIResponder, _UIFocusSystemSceneComponent, _UIFocusLinearMovementCache, UIView, _UIFocusUpdateThrottle, _UIFocusCastingController, _UIFocusSoundGenerator, UIFocusAnimationCoordinator, UIFocusMovementAction, _UIFocusAnimationCoordinatorManager, NSArray, _UIFocusItemFrameReporter, _UIFocusEffectManager, _UIFocusGroupHistory, _UIFocusEventDelivery;
...
- (id)_contextForUpdateToEnvironment:(id)a0 withAnimationCoordinator:(id)a1 allowsOverridingPreferedFocusEnvironments:(BOOL)a2;
