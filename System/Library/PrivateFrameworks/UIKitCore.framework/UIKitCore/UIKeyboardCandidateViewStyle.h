...
+ (id)disambiguationStyleForDarkKeyboard:(BOOL)a0;
+ (id)lightKeyboardStyle;
+ (id)lightKeyboardStyleForDisambiguation;
+ (id)styleForDarkKeyboard:(BOOL)a0;
+ (id)tvGridStyleForDarkKeyboard:(BOOL)a0;
+ (id)tvLinearStyleForDarkKeyboard:(BOOL)a0;
