@class UINotificationFeedbackGenerator, _UIRemoteView, _UISheetPresentationControllerConfiguration, _UIEventDeferringOwnershipToken, _UIAsyncInvocation, BKSTouchDeliveryPolicyAssertion, _UISizeTrackingView, _UITextEffectsRemoteView, UIDimmingView, UIView, _UIViewServiceInterface, NSString, _UIRemoteViewService, UIAlertController, NSArray, _UIRemoteViewControllerSceneContext, _UITextServiceSession, NSError, FBSDisplayIdentity;
