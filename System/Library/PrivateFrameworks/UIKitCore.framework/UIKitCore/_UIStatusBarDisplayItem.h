@class NSTimer, UIView, _UIStatusBarItem, NSString, _UIStatusBarIdentifier, _UIStatusBarRegion, _UIStatusBarDisplayItemPlacement, _UIStatusBarAction, _UIStatusBarStyleAttributes, NSMutableIndexSet;
...
@property (readonly, nonatomic) struct CGRect { struct CGPoint { double x; double y; } origin; struct CGSize { double width; double height; } size; } absolutePresentationFrame;
