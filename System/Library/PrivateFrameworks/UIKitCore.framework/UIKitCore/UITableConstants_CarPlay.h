...
- (id)_defaultAccessoryColorFocused:(BOOL)a0;
- (struct UIEdgeInsets { double x0; double x1; double x2; double x3; })_defaultLayoutMargins;
- (double)_defaultPlainHeaderFooterHeightForTableViewStyle:(long long)a0;
- (id)_imageWithName:(id)a0 accessoryBaseColor:(id)a1;
- (unsigned long long)contentClipCornersForCell:(id)a0 inTableView:(id)a1;
...
- (id)defaultAccessoryColorForCell:(id)a0 inTableView:(id)a1;
...
- (id)defaultFocusedAccessoryColorForCell:(id)a0 inTableView:(id)a1;
...
- (double)defaultGroupedFooterHeightForTableView:(id)a0;
- (double)defaultGroupedHeaderHeightForTableView:(id)a0;
...
- (struct UIEdgeInsets { double x0; double x1; double x2; double x3; })headerFooterOffsetFromContentInsetForTableView:(id)a0;
