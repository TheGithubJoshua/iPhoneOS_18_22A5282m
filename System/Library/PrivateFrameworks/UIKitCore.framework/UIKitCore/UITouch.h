@class UIView, NSString, NSArray, BKSHIDEventAuthenticationMessage, UIWindow, UIResponder, NSMutableArray, _UITouchPredictor, NSNumber;
...
@property (retain, nonatomic, setter=_setAuthenticationMessage:) BKSHIDEventAuthenticationMessage *_authenticationMessage;
