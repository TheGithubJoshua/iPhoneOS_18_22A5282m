@class _UIRotaryGestureRecognizer, _UIFocusMovementTabulatorPressGestureRecognizer, _UIFocusEnableOnSelectGestureRecognizer, _UIFocusLinearMovementDebugGestureRecognizer, NSString, _UIFocusMovementDirectionalPressGestureRecognizer, NSTimer, NSArray, _UIFocusEngineJoystickGestureRecognizer, _UIFocusEnginePanGestureRecognizer, _UIFocusSelectObserverGestureRecognizer, NSSet, UIView, _UIFocusLinearMovementDebugView, _UIFocusMovementInfo, _UIFocusEffectsController, _UIFocusFastScrollingRecognizer, CADisplayLink, UIMoveEvent, UIScrollView, CARInputDeviceTouchpad, UITapGestureRecognizer;
...
- (void)_linearDebugGestureRecognizerUpdateForcingRemoval:(BOOL)a0 studyLogData:(id)a1;
- (void)_stopMomentumAndPerformRollback;
- (struct CGVector { double x0; double x1; })_accelerationFactorForCurrentVelocity:(struct CGPoint { double x0; double x1; })a0 isRotaryGesture:(BOOL)a1 isFocusInKeyboard:(BOOL)a2 remoteTouchSurfaceType:(unsigned long long)a3;
...
- (void)_arrowButtonGestureUpdateForcingRemoval:(BOOL)a0 studyLogData:(id)a1;
...
- (BOOL)_attemptRotaryFocusMovementWithLinearHeading:(unsigned long long)a0 directionalHeading:(unsigned long long)a1 request:(id)a2 acceleratedVelocity:(struct CGPoint { double x0; double x1; })a3 studyLogData:(id)a4;
...
- (void)_joystickGestureRecognizerUpdateForcingRemoval:(BOOL)a0 studyLogData:(id)a1;
...
- (void)_pageButtonGestureUpdateForcingRemoval:(BOOL)a0 studyLogData:(id)a1;
- (void)_panGestureCancelled:(id)a0;
- (void)_panGestureRecognizerUpdateForcingRemoval:(BOOL)a0 studyLogData:(id)a1;
- (void)_panGestureStart:(id)a0;
- (struct CGPoint { double x0; double x1; })_pointForLinearValue:(double)a0;
...
- (void)_rotaryGestureRecognizerUpdateForcingRemoval:(BOOL)a0 studyLogData:(id)a1;
- (void)_selectGestureRecognizerUpdateForcingRemoval:(BOOL)a0 studyLogData:(id)a1;
- (void)_selectObserverGestureRecognizerUpdateForcingRemoval:(BOOL)a0 studyLogData:(id)a1;
...
- (void)_tabulatorGestureUpdateForcingRemoval:(BOOL)a0 studyLogData:(id)a1;
- (void)_tapGestureRecognizerUpdateForcingRemoval:(BOOL)a0 studyLogData:(id)a1;
...
- (void)_updateRotaryDistance:(double)a0 delta:(double)a1 reportedVelocity:(double)a2 remoteTouchSurfaceType:(unsigned long long)a3;
...
- (BOOL)rotaryGestureRecognizerCanBeginFromRest:(id)a0;
- (void)rotaryGestureRecognizerFailedToBeginFromRest:(id)a0;
- (void)rotaryGestureRecognizerIsAttemptingToBeginFromRest:(id)a0;
- (BOOL)rotaryGestureRecognizerMustBeginFromRest:(id)a0;
