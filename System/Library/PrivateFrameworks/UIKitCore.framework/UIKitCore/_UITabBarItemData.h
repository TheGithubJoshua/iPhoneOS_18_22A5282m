...
- (id)badgeTextAttributesForState:(long long)a0 compatibleWithTraitCollection:(id)a1;
...
- (id)_fallbackTitleFontForState:(long long)a0 compatibleWithTraitCollection:(id)a1;
- (id)_fallbackBadgeTitleFontForState:(long long)a0 compatibleWithTraitCollection:(id)a1;
- (void).cxx_destruct;
- (id)titleTextAttributesForState:(long long)a0 compatibleWithTraitCollection:(id)a1;
