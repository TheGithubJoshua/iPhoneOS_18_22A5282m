@class _UISpringParameters, _UIHyperInteractor, NSString, UIViewSpringAnimationBehavior;
...
@property (retain, nonatomic, setter=_setOverrideSpringAnimationBehavior:) id<UIViewSpringAnimationBehaviorDescribing> _overrideSpringAnimationBehavior;
