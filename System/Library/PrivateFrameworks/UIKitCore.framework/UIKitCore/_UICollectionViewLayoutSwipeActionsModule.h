...
@interface _UICollectionViewLayoutSwipeActionsModule : NSObject <UISwipeActionHost_Internal> {
    struct { unsigned char layoutUpdateOrRefreshPending : 1; unsigned char preserveExistingLayoutAttributesForSwipedViews : 1; } _flags;
}
...
- (BOOL)_canIgnoreInvalidationContext:(id)a0;
