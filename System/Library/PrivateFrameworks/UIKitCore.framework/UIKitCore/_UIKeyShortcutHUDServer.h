@class UIPhysicalKeyboardEvent, NSString, _UIKeyShortcutHUDWindow, _UIKeyShortcutHUDViewController, _UIKeyShortcutHUDServerSession, _UIEventDeferringOwnershipToken, _UIKeyShortcutHUDModifierKeyListener;
...
@property (retain, nonatomic) _UIEventDeferringOwnershipToken *systemKeyboardShortcutOverlayEnvironmentEventDeferringToken;
@property (retain, nonatomic) id<BSInvalidatable> additionalEventDeferringRulesToken;
