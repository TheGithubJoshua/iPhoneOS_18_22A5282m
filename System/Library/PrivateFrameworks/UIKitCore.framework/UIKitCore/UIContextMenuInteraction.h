@class UIGestureRecognizer, _UIContextMenuAnimator, _UIClickPresentationInteraction, UIContextMenuConfiguration, NSArray, NSMutableDictionary, NSString, UIView, _UIWindowSceneActivationAnimator, _UIContextMenuPresentation;
...
@interface UIContextMenuInteraction : NSObject <_UIClickPresentationInteractionDelegateInternal, _UIContextMenuPresentationControllerDelegate, _UIContextMenuPresentationAnimationDelegate, UIDeferredMenuElementDelegate, _UIVisualStyleStylable, _UIWindowSceneActivator_Internal, UIInteraction> {
    struct { BOOL highlightPreviewForItemWithIdentifier; BOOL dismissalPreviewForItemWithIdentifier; BOOL willPerformPreviewAction; BOOL willDisplay; BOOL willEndForConfiguration; BOOL styleForMenu; BOOL accessoriesForMenu; BOOL failedToBeginForSecondaryClickAtLocation; BOOL shouldByDelayedByGestureRecognizer; BOOL asyncConfigurationForMenuAtLocation; BOOL overrideSuggestedActions; BOOL shouldPresent; BOOL shouldAllowDragAfterDismiss; BOOL shouldAllowSwipeToDismiss; BOOL interactionEffectForTargetedPreview; BOOL shouldAttemptToPresentConfiguration; BOOL previewForHighlighting; BOOL previewForDismissing; BOOL _dci_secondaryHighlightPreview; BOOL _dci_secondaryDismissalPreview; BOOL willCommit; BOOL willPresent; BOOL didEnd; } _delegateImplements;
}
...
@property (nonatomic, setter=_setPassthroughInteractionTouchEatingDisabledForSearchSuggestions:) BOOL _passthroughInteractionTouchEatingDisabledForSearchSuggestions;
...
- (void)_retargetDismissingMenuWithIdentifier:(id)a0 toPreview:(id)a1 force:(BOOL)a2;
...
- (id)animator:(id)a0 previewForSecondaryItem:(id)a1 dismissingWithStyle:(unsigned long long)a2;
