@class NSDateComponents, UICollectionView, NSDate, UICalendarSelection, _UICalendarViewDecorationSystem, NSLocale, NSTimeZone, NSDateFormatter, _UICalendarHeaderView, UIView, NSCalendar, NSString, UICollectionViewDiffableDataSource, _UICalendarMonthYearSelector, _UIDatePickerLinkedLabel, NSDateInterval, _UICalendarDataModel, _UICalendarViewDataSourceController, _UICalendarWeekdayView;
