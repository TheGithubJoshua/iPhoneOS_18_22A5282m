@class UIView, UIMenu, NSString, _UIContextMenuSelectionGestureRecognizer, CAShapeLayer, _UIEditMenuPageButton, UICollectionViewDiffableDataSource, _UIEditMenuCollectionView, NSIndexPath;
...
@property (weak, nonatomic) id<_UIEditMenuListViewDelegate> delegate;
...
+ (double)minimumRequiredWidthForArrowInRoundedListViewForAxis:(long long)a0;
...
- (id)initWithMenu:(id)a0 titleView:(id)a1;
