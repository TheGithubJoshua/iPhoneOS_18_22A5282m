@class NSTimer, NSString, UIView, STVoiceControlStatusDomainPublisher, NSOperationQueue, NSMutableArray, NSMutableSet, CACVoiceOverAnnouncer, SBSSystemApertureLayoutMonitor;
