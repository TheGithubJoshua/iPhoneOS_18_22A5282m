@class SYVectorClock, NSDictionary, NSObject, SYSyncEngine, SYDevice, NSMutableArray, SYPersistentStore, NSString, _SYMultiSuspendableQueue, NSMutableSet, SYSession, PBCodable, _SYQueuedStartSession;
