...
- (int)_determineTapStyleNoise:(id)a0;
- (struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })_determineTransformationinFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 cumulativeWidth:(double)a1 scale:(double)a2 characterHeight:(double)a3 rotationBias:(double)a4;
