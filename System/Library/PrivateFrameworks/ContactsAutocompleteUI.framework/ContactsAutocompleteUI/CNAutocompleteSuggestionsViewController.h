@class CNAvatarImageRenderer, NSObject, NSArray, NSString, UICollectionViewDiffableDataSource, UICollectionViewLayout, CNAutocompleteSearchManager, UICollectionView, NSNumber, NSMutableArray;
