@class MUPlaceCardAnalyticsController, GEOCyclingOptions, MUPlaceViewControllerConfiguration, MUPlacePhotoSectionController, MUPlaceInlineMapSectionController, UIScrollView, MKMapItem, MKMapItemIdentifier, _MKPlaceActionButtonController, MKPlaceActionEnvironment, CNContact, CNContactViewController, MUTimeExpirableLRUCache, MUPlaceInfoSectionController, MUPlaceUnifiedActionRowSectionController, MUPlaceActionManager, UILayoutGuide, MUPlaceActionRowSectionController, MULoadingOverlayController, MUShareSheetPresenter, MKLookAroundContainerView, MKLookAroundView, CLLocation, NSArray, GEOWalkingOptions, MUContactStore, MUScrollableStackView, MUCuratedGuidesSectionController, GEOAutomobileOptions, MUPersonalGuidesSectionController, NSString, GEOTransitOptions, MUAMSResultProvider, _MKPlaceViewController, MUPlaceHeaderSectionController, MKETAProvider, MKUGCCallToActionViewAppearance, MUScrollViewImpressionsCalculator, NSUUID, UIImage, MUPlaceEnrichmentSectionController, MUPlaceHeaderButtonsSectionController;
@protocol MUPlaceViewControllerDelegate, _MKPlaceItem, MUPlaceViewControllerMapsAppDelegate, MUPlaceViewControllerFeedbackDelegate, UIScrollViewDelegate;
...
- (BOOL)canShowAddPhotosForPlaceCardActionController:(id)a0;
...
- (void)presentPOIEnrichmentWithPresentationOptions:(id)a0 originTarget:(id)a1;
