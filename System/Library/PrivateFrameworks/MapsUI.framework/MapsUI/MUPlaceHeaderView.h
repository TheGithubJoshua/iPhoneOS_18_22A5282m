@class UILabel, MUPlaceCoverPhotoOptions, UILayoutGuide, MKTransitInfoLabelView, UIView, MUImageView, NSString, NSLayoutConstraint, MUStackLayout, MUPlaceCoverPhotoTransitionController, MULinkView, MUVerifiedLogoImageView, MUCardButton;
