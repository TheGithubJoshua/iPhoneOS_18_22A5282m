@class UIView, MUPlaceSectionFooterViewModel, NSArray, NSString, MUPlaceSectionHeaderViewModel, MUCuratedGuidesSectionView, MUCuratedCollectionsPlacecardAnalyticsManager, UIViewController, MUPlaceSectionView, MKUGCCallToActionViewAppearance;
