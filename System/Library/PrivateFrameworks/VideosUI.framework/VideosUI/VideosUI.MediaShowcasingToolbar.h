@interface VideosUI.MediaShowcasingToolbar : UIView {
    void /* unknown type, empty encoding */ onFullscreenPressed;
    void /* unknown type, empty encoding */ onMutePressed;
    void /* unknown type, empty encoding */ isMuted;
    void /* unknown type, empty encoding */ shouldShowFullScreenButton;
    ...
    void /* unknown type, empty encoding */ fullScreenImageName;
