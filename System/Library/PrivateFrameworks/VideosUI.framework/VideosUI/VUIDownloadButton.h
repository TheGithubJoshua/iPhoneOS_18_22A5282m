@class UIView, UIViewController, UIImage, VUIDownloadButtonViewModel, VUITextLayout, VUIDownloadButtonActionHandler, CAShapeLayer, UIImageView, VUICircularProgress, UIImageSymbolConfiguration, UIColor;
...
- (id)_badgeImageForDownloadState:(unsigned long long)a0 downloadExpirationDate:(id)a1 hasFailed:(BOOL)a2;
