@class SBIconPageIndicatorImageSetCache, SBHIconImageCache, SBReusableViewMap, UIImpactFeedbackGenerator, SBRootFolderController, NSMutableArray, SBFolderIconImageCache, SBHIconShareSheetManager, SBSearchGesture, SBIconView, SBFloatingDockViewController, NSMutableSet, ATXDefaultWidgetSuggesterClient, SBIconPreviousLocationTracker, SBFolderController, BSEventQueue, NSMapTable, NSCountedSet, SBHWidgetIntroductionFeatureIntroductionItem, SBHFeatureIntroductionManager, UIViewController, SBHHomeScreenSettings, _UILegibilitySettings, SBIcon, SBHomeScreenIconTransitionAnimator, SBWorkspaceInteractionContext, SBHLibraryViewController, SBFParallaxSettings, SBHWidgetMetricsProvider, SBHHomeScreenUsageMonitor, SBIconListView, ATXHomeScreenPageIconRanker, NSArray, SBHProactivePageSuggestionsManager, NSMutableDictionary, SBRootFolder, NSString, SBFolder, SBHFocusModeManager, SBIconDragManager, SBHWidgetIntroductionSettings, SBHIconModel, SBIconLabelImageCache, NSHashTable, NSTimer, CHSWidgetDescriptorProvider, NSObject, SBHRootFolderSettings, NSSet, SBHMultiplexingManager, SBFolderIcon, SBHPeopleWidgetPersonDetailInteraction, SBHomeScreenDefaults;
@protocol SBHRootFolderCustomViewPresenting, SBHIconManagerDelegate, SBHLegibility, OS_os_activity, SBHTodayViewController, SBHIconRootViewProviding, BSInvalidatable, SBIconListLayoutProvider;
...
@property (readonly, nonatomic) CHSWidgetDescriptorProvider *widgetDescriptorProvider;
...
- (BOOL)iconDragManagerCanBeginIconDrags:(id)a0;
