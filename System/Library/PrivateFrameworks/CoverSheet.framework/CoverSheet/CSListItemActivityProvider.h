@class CSListItemSection, NSMutableDictionary, DMFApplicationPolicyMonitor, NSString, ACActivityCenter, NSMutableArray;
@protocol CSListItemManaging, BSInvalidatable;
...
@property (retain, nonatomic) id<BSInvalidatable> activityExceedingReducedPushLevelSubscriber;
@property (retain, nonatomic) id<BSInvalidatable> activityContentUpdateSubscriber;
