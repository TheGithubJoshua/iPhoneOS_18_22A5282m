...
@property (copy, nonatomic) id /* block */ didSaveShareBlock;
@property (copy, nonatomic) id /* block */ didStopSharingBlock;
@property (copy, nonatomic) id /* block */ didFailToUpdateShareBlock;
