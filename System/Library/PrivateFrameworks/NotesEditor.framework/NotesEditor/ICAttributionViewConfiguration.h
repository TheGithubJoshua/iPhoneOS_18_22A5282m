@class NSDate, NSString, UIImage, NSAttributedString, NSOrderedSet, NSArray, ICAttributionViewConfigurationSharedState, NSMutableArray, NSObject, TTTextEdit;
...
@property (readonly, nonatomic) TTTextEdit *textEdit;
