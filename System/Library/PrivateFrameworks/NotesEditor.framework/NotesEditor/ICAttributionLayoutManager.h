@class NSDate, TTTextEditFilter, NSArray, NSManagedObjectContext, ICBaseTextView, TTTextEditGrouper, NSObject, NSNumber;
...
@property (retain, nonatomic) TTTextEditGrouper *editGrouper;
