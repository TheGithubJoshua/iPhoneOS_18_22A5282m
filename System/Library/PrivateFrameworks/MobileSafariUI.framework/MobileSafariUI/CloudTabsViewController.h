@class NSTimer, NSString, NSArray, CloudTabStore, UISearchController, UITableView, PreviewTableViewController, UIBarButtonItem;
@protocol _SFNavigationIntentHandling, TabGroupProvider, LinkPreviewProvider, CloudTabsViewControllerDelegate;
...
- (id)initWithCloudTabStore:(id)a0 primaryDeviceUUID:(id)a1;
