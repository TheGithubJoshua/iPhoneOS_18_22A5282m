@class NSString, TabDocumentDropHandler, NSMapTable, NSMutableSet;
...
+ (BOOL)canDelegateDragDropForTabCollectionView:(id)a0;
...
- (id)_newDragItemsAtPoint:(struct CGPoint { double x0; double x1; })a0 excludingTabDocuments:(id)a1 interaction:(id)a2 session:(id)a3;
...
- (void)_updatePreviewsForSession:(id)a0 pinned:(BOOL)a1;
