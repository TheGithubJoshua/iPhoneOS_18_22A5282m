@class CompletionGroupListing, NSArray, WBSCompletionQuery, NSString, SFSearchResult, WBSQuerySuggestion;
...
@property (copy, nonatomic) NSArray *completionGroupsToRestore;
