@class ReorderingAutoscroller, UIVisualEffectView, UITapGestureRecognizer, NSMutableArray, UIView, PinnedTabsOverflowButton, NSString, UIDragInteraction, SFTabHoverPreviewController, UIHoverGestureRecognizer, UIScrollView, NSIndexSet, NSArray, UIPanGestureRecognizer;
