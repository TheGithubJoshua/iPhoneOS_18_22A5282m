@class UIImageView, NSDate, NSObject, NTKWorldClockHighlightedMapLocationView, CLKClockTimerToken, UIColor, NSCalendar, NSString, NSArray, CLKDevice, NSNumber, UIFontDescriptor, UIImage;
...
@property (retain, nonatomic) UIImage *terminator;
@property (retain, nonatomic) UIImageView *terminatorView;
