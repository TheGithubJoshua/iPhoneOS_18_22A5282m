...
- (id)initWithProfile:(id)a0 concept:(id)a1 preloadedRemovedRecords:(id)a2 removedRecordsOnly:(BOOL)a3 displayItemOptions:(long long)a4 sampleTypes:(id)a5 filter:(id)a6 additionalPredicates:(id)a7 sortDescriptors:(id)a8;
