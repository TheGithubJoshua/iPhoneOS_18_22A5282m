...
+ (id)buildWithIdentifier:(id)a0 requirePasscode:(id)a1 requireAlphanumericPasscode:(id)a2 requireComplexPasscode:(id)a3 minimumLength:(id)a4 minimumComplexCharacters:(id)a5 maximumFailedAttempts:(id)a6 failedAttemptsResetInMinutes:(id)a7 maximumGracePeriodInMinutes:(id)a8 maximumInactivityInMinutes:(id)a9 maximumPasscodeAgeInDays:(id)a10 passcodeReuseLimit:(id)a11 changeAtNextAuth:(id)a12;
