...
+ (id)buildWithIdentifier:(id)a0 declarationIdentifier:(id)a1 visibleName:(id)a2 hostname:(id)a3 port:(id)a4 username:(id)a5 isMailEnabled:(id)a6 areNotesEnabled:(id)a7;
