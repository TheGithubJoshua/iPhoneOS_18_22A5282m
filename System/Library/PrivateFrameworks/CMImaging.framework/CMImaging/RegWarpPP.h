@class NSString, FigMetalAllocator, NSObject;
@protocol OS_dispatch_queue, OS_dispatch_group;

@interface RegWarpPP : NSObject <CMIRegWarp> {
    struct rwppRegistrationEngineS { struct { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; float x7; float x8; unsigned int x9; BOOL x10; BOOL x11; } x0; struct { unsigned int x0; unsigned int x1; struct rwppRegistrationEngineS *x2; struct *x3; unsigned int x4; unsigned int x5; struct { unsigned int x0; struct *x1; struct *x2; struct { unsigned int x0[256]; } x3; } x6; struct { unsigned int x0; } x7; } x1[4]; struct { BOOL x0; unsigned int x1; unsigned int x2; unsigned int x3; BOOL x4; } x2; BOOL x3; unsigned int x4; unsigned int x5; struct { char *x0[2]; struct { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; } x1; unsigned int x2; struct { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } x3; } x6; unsigned int x7; unsigned int x8; struct { char *x0[2]; struct { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; } x1; unsigned int x2; struct { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } x3; } x9[8]; struct { unsigned int x0; void /* unknown type, empty encoding */ x1[1024]; unsigned short x2[1024]; } x10[8]; struct { void /* unknown type, empty encoding */ x0[1024]; void /* unknown type, empty encoding */ x1[1024]; void /* unknown type, empty encoding */ x2[1024]; void /* unknown type, empty encoding */ x3[1024]; } x11; float x12[1024]; struct { float x0; unsigned int x1; struct { unsigned int x0; unsigned short x1[2][1024]; } x2; struct { unsigned int x0; unsigned short x1[2][1024]; } x3; struct { unsigned int x0; unsigned short x1[2][1024]; } x4; } x13; struct { unsigned char x0[256]; } x14; struct { unsigned int x0; char *x1; unsigned int x2; char *x3; struct { unsigned short x0; unsigned short x1; unsigned short x2; } x4[1024]; unsigned int x5; } x15; id x16; id x17; } *_regEng;
...
+ (int)CheckParameters:(struct { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; float x7; float x8; unsigned int x9; BOOL x10; BOOL x11; } *)a0 imageWidth:(unsigned int)a1 imageHeight:(unsigned int)a2 imageFormat:(unsigned int)a3;
+ (unsigned int)computeExternalMemoryBlockSize:(struct { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; float x7; float x8; unsigned int x9; BOOL x10; BOOL x11; } *)a0 imageWidth:(unsigned int)a1 imageHeight:(unsigned int)a2 imageFormat:(unsigned int)a3;
...
+ (void)getDefaults:(struct { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; float x7; float x8; unsigned int x9; BOOL x10; BOOL x11; } *)a0;
+ (unsigned int)getMaxNumCorners;

- (void)releaseResources;
- (id)initWithConfig:(struct { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; float x7; float x8; unsigned int x9; BOOL x10; BOOL x11; } *)a0;
- (void).cxx_destruct;
- (void)dealloc;
...
- (int)processNonReference:(struct __CVBuffer { } *)a0 gdcParams:(struct { float x0; float x1; float x2[8]; float x3[8]; } *)a1 seedTransform:(struct { float x0[9]; } *)a2 outputTransform:(struct { float x0[9]; } *)a3 mapping:(struct { unsigned char x0[256]; } *)a4;
...
- (int)processReference:(struct __CVBuffer { } *)a0 gdcParams:(struct { float x0; float x1; float x2[8]; float x3[8]; } *)a1 regionOfInterest:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a2 numKeypoints:(unsigned int *)a3 mapping:(struct { unsigned char x0[256]; } *)a4;
