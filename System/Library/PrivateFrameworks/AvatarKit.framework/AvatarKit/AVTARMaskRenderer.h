...
- (void)_updateMaskParametersWithNeckPivotPosition:(SEL)a0;
...
- (void)updateMaskParametersWithNeckPivotNode:(id)a0;
- (void)updateMaskParametersWithNeckPivotNodes:(id)a0;
