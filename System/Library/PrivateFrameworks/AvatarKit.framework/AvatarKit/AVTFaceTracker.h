...
- (void)updateWithARFrame:(id)a0 captureOrientation:(long long)a1 interfaceOrientation:(long long)a2 mirroredDepthData:(BOOL)a3;
- (void)updateWithARFrame:(id)a0 worldAlignment:(long long)a1 fallBackDepthData:(id)a2 captureOrientation:(long long)a3 interfaceOrientation:(long long)a4 mirroredDepthData:(BOOL)a5;
