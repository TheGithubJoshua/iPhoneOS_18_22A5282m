...
@property (nonatomic, getter=isPrivacyProxyEnabled) BOOL isPrivacyProxyEnabled;
@property (nonatomic, getter=networkQualityResponsiveness) double networkQualityResponsiveness;
@property (copy, nonatomic, getter=networkQualityDate) NSDate *networkQualityDate;
