@class WFNetworkScanRecord, NSString, NSArray, WFNetworkProfile, WFDiagnosticsContext, NetworkQualityExecutions, UIViewController, WFIPMonitor;
...
@property (nonatomic, getter=isAutoJoinConfigurable) BOOL autoJoinConfigurable;
...
- (id)initWithNetwork:(id)a0 profile:(id)a1 ipMonitor:(id)a2 privateMACConfig:(id)a3 wifiModeConfig:(id)a4;
