@class OUObjectAsset, OUPointCloud, NSArray, NSSet, NSMutableDictionary, OU3DObjectMerger, _OUFrame, OUObjectCompleteness;
...
@interface OU3DObjectDetector : NSObject {
    ...
    struct map<NSString *, short, CompareNSString, std::allocator<std::pair<NSString *const, short>>> { struct __tree<std::__value_type<NSString *, short>, std::__map_value_compare<NSString *, std::__value_type<NSString *, short>, CompareNSString, true>, std::allocator<std::__value_type<NSString *, short>>> { void *__begin_node_; struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<NSString *, short>, void *>>> { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __value_; } __pair1_; struct __compressed_pair<unsigned long, std::__map_value_compare<NSString *, std::__value_type<NSString *, short>, CompareNSString, true>> { unsigned long long __value_; } __pair3_; } __tree_; } obj_type_to_index;
    ...
    struct vector<float __attribute__((ext_vector_type(3))), std::allocator<float __attribute__((ext_vector_type(3)))>> { void *__begin_; void *__end_; struct __compressed_pair<float * __attribute__((ext_vector_type(3))), std::allocator<float __attribute__((ext_vector_type(3)))>> { void *__value_; } __end_cap_; } model_input_pc_;
    struct vector<unsigned char __attribute__((ext_vector_type(4))), std::allocator<unsigned char __attribute__((ext_vector_type(4)))>> { void *__begin_; void *__end_; struct __compressed_pair<unsigned char * __attribute__((ext_vector_type(4))), std::allocator<unsigned char __attribute__((ext_vector_type(4)))>> { void *__value_; } __end_cap_; } model_input_labels_;
    struct vector<unsigned short __attribute__((ext_vector_type(4))), std::allocator<unsigned short __attribute__((ext_vector_type(4)))>> { void *__begin_; void *__end_; struct __compressed_pair<unsigned short * __attribute__((ext_vector_type(4))), std::allocator<unsigned short __attribute__((ext_vector_type(4)))>> { void *__value_; } __end_cap_; } model_input_votes_;
    int pred_boxes_cnt_;
    ...
    struct unique_ptr<OU3DODInterface, std::default_delete<OU3DODInterface>> { struct __compressed_pair<OU3DODInterface *, std::default_delete<OU3DODInterface>> { struct OU3DODInterface *__value_; } __ptr_; } ssd_model_;
    struct unique_ptr<OU3DODInterface, std::default_delete<OU3DODInterface>> { struct __compressed_pair<OU3DODInterface *, std::default_delete<OU3DODInterface>> { struct OU3DODInterface *__value_; } __ptr_; } ssd_offline_model_;
...
- (id)run;
- (BOOL)preprocess;
- (id)updateWithKeyframes:(id)a0 ouframe:(id)a1;
...
- (BOOL)shouldUpdateForFrame:(id)a0;
- (void)updateFrustumPointCloudWithFrame:(id)a0 scenUnderstandingPose:(struct float4x4 { void /* unknown type, empty encoding */ x0[4]; })a1;
- (void)updatePointCloudWithKeyframes:(id)a0;
- (id)updateWithKeyframes:(id)a0 currentCameraPose:(struct { void /* unknown type, empty encoding */ x0[4]; })a1;
- (id)updateWithKeyframes:(id)a0 currentCameraPose:(struct { void /* unknown type, empty encoding */ x0[4]; })a1 currentCamera:(id)a2;
