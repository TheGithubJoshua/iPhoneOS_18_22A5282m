...
- (void)sessionService:(id)a0 didBecomeActiveWithActivationContext:(id)a1 turnID:(id)a2;
...
- (void)sessionService:(id)a0 willBecomeActiveWithActivationContext:(id)a1 turnID:(id)a2;
