...
- (id)_windowWithUserInteractionEnabled:(BOOL)a0 windowLevel:(double)a1 createIfNeeded:(BOOL)a2 purposeIdentifier:(id)a3 userInterfaceStyle:(long long)a4 allowSystemAppHosting:(BOOL)a5 windowScene:(id)a6 savedWindowScene:(id)a7;
