...
- (id)initWithCellularPlan:(id)a0 uuid:(id)a1 iccid:(id)a2 name:(id)a3 type:(long long)a4 phoneNumber:(id)a5 label:(id)a6 isLocalTransferToeSIMSupported:(BOOL)a7 isTransferred:(BOOL)a8 transferredStatus:(long long)a9 transferredToDeviceDisplayName:(id)a10 supportedTransferOption:(unsigned long long)a11;
- (id)initWithCellularPlan:(id)a0 uuid:(id)a1 type:(long long)a2 phoneNumber:(id)a3 label:(id)a4 transferredStatus:(long long)a5 transferredToDeviceDisplayName:(id)a6 supportedTransferOption:(unsigned long long)a7;
- (id)initWithIccid:(id)a0 uuid:(id)a1 name:(id)a2 phoneNumber:(id)a3 label:(id)a4 isLocalTransferToeSIMSupported:(BOOL)a5 isTransferred:(BOOL)a6 transferredStatus:(long long)a7 transferredToDeviceDisplayName:(id)a8 supportedTransferOption:(unsigned long long)a9;
