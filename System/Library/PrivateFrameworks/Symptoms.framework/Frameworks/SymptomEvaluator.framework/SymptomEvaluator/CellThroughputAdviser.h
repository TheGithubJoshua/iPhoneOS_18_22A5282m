@class NSString, NWUsageTargetSelector, NSSet, FlowScrutinizer, NSMutableDictionary, WiFiViabilityMonitor, NSMutableSet, FlowOracle, FlowRefreshScheduler, NSObject, AWDSymptomsCellularSDMAdviceChange;
