@class PXTouchingUIGestureRecognizer, PXFeedContentLayout, PXFeedViewModel, UITapGestureRecognizer, PXFeedTitleLayout, PXGView, PXGSplitLayout, UIHoverGestureRecognizer, PXStoryTransitionableTungstenViewManager, NSString;
