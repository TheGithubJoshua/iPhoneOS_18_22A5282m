...
+ (id)memoriesTitleSubtitleSpecForContext:(struct { long long x0; long long x1; long long x2; struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x3; struct UIEdgeInsets { double x0; double x1; double x2; double x3; } x4; BOOL x5; })a0;
