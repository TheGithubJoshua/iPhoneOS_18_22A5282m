@class PXPhotosGridFooterStatusController, PXMediaProvider, PXUpdater, PXAssetsDataSourceCountsController, PXExtendedTraitCollection, UIView, NSString, PXPhotosViewInteraction, NSUndoManager, PXPhotosBarsController, PXPhotosLayout, PXGView, PXPhotosGridFooterPresentation, PXAssetReference, PXPhotosViewModel;
