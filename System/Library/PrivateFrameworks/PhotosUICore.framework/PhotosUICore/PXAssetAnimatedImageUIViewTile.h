@class PHAnimatedImage, NSString, PXImageRequester, UIView, ISAnimatedImageView;
...
- (void)_handleAnimatedImageResult:(id)a0 info:(id)a1 expectedRequestCount:(unsigned long long)a2;
