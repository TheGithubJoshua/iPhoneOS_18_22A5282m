...
- (BOOL)_getAdditionalTileIdentifierForEditorial:(out struct PXTileIdentifier { unsigned long long x0; unsigned long long x1[10]; } *)a0 group:(out unsigned long long *)a1 layoutGeometryKind:(long long)a2 indexPath:(struct PXSimpleIndexPath { long long x0; long long x1; long long x2; long long x3; })a3;
- (BOOL)_getAdditionalTileIdentifierForGrid:(out struct PXTileIdentifier { unsigned long long x0; unsigned long long x1[10]; } *)a0 group:(out unsigned long long *)a1 layoutGeometryKind:(long long)a2 indexPath:(struct PXSimpleIndexPath { long long x0; long long x1; long long x2; long long x3; })a3;
