...
- (BOOL)scaleSegmentationPixelOutputBuffer:(struct __CVBuffer **)a0 confidencePixelOutputBuffer:(struct __CVBuffer **)a1 normalPixelOutputBuffer:(struct __CVBuffer **)a2 targetResolution:(struct CGSize { double x0; double x1; })a3;
