@class UITextInputPayloadController, CKChatEagerUploadController, CKScheduledUpdater, NSDate, UINavigationController, IMBalloonPluginDataSource, CKHandwritingPresentationController, UIViewController, CKKeyboardContentViewController, UIView, CKMessageEntryView, IMScheduledUpdater, NSString, CKDeviceOrientationManager, CKBrowserSwitcherViewController, IMBalloonPlugin;
...
- (void)presentModernCardForPlugin:(id)a0 presentationStyle:(unsigned long long)a1;
...
- (unsigned long long)presentationStyleInOrientation:(long long)a0 forPluginID:(id)a1;
