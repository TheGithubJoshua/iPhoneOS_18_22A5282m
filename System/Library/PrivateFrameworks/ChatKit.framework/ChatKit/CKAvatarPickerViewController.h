@class CKAvatarTitleCollectionReusableView, CKEntity, NSString, CKConversation, CNContactStore, CKAvatarPickerLayout, CNGroupAvatarViewController, NSMapTable, UICollectionView;
