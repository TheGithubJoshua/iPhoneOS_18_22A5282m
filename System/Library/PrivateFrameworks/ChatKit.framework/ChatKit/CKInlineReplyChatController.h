@class NSDictionary, NSString, UIVisualEffectView, CKInlineReplyCollectionViewController, IMMessageItem, CKTranscriptOverlayTransitionContext, UINavigationBarAppearance;
