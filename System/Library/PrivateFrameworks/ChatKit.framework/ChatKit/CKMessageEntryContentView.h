@class CKConversation, _SWCollaborationShareOptions, UIFont, NSDictionary, CKMessageEntryTextView, UIViewController, UIButton, UIView, IMPluginPayload, NSString, CKMediaObject, CKMessageEntryRichTextView, CKComposition, NSArray, UIImpactFeedbackGenerator;
