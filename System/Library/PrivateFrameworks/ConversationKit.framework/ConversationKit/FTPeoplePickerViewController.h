@interface FTPeoplePickerViewController : UIViewController <TPPillViewDelegate, TUCallProviderManagerDelegate, CNAutocompleteSearchControllerDelegate, CNContactPickerDelegate, MFMessageComposeViewControllerDelegate> {
...
- (id)initWithStyle:(long long)a0 existingAddresses:(id)a1 currentConversation:(id)a2 stagedActivity:(id)a3;
