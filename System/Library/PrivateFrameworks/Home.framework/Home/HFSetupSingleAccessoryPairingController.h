@class NSHashTable, NSString, NAFuture, NSDate, NSSet, HMHome, HFDiscoveredAccessory, HFSetupPairingContext, HFSetupAccessoryResult, HMAccessorySetupCompletedInfo;
