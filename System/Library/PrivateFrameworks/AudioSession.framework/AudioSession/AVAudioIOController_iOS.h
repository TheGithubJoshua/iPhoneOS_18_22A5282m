...
- (id)initWithSession:(id)a0 xpcConnection:(struct shared_ptr<as::client::XPCConnection> { struct XPCConnection *x0; struct __shared_weak_count *x1; })a1 timingStateSlot:(unsigned int)a2 isDecoupledInput:(BOOL)a3;
