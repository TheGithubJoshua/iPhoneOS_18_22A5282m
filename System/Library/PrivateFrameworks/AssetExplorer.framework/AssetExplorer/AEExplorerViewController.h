...
@property (nonatomic, setter=_setDidPresentPhotoLibrary:) BOOL _didPresentPhotoLibrary;
...
- (void)showPhotoLibraryPicker:(id)a0;
...
- (void)_handleImagePickerMediaWithInfo:(id)a0;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_sourceRectForPhotoLibraryPresentationInCoordinateSpace:(id)a0;
...
- (void)ppt_scrollThumbnailGridWithTestName:(id)a0 fakeExpensiveBadges:(BOOL)a1;
