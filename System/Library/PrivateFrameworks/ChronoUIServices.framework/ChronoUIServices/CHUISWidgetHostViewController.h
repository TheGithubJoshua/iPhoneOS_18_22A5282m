@class UIVisualEffectView, CHSInlineTextParameters, UILabel, CHUISWidgetSceneClientSettings, CHSWidgetDescriptor, NSString, NSMutableArray, BSContinuousMachTimer, CHUISWidgetVisibilitySettings, NSArray, NSMutableDictionary, CHUISKeybag, CHSScreenshotManager, BSUIVibrancyConfiguration, CHUISPreferences, UIView, _UICAPackageView, FBSceneWorkspace, BSUIVibrancyEffectView, BLSHBacklightFBSceneEnvironmentActionHandler, UIImageView, CHSWidgetTintParameters, FBScene, CHSWidgetMetrics, CHSWidget, CHSWidgetDescriptorProvider;
