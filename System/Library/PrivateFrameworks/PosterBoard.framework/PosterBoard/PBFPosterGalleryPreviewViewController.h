@class NSTimer, NSString, UINavigationController, NSSet, PBFPosterGalleryDataProvider, PBFPosterGalleryPreviewView, NSMutableSet, _PBFGalleryCollectionViewController, PBFGalleryEditingSceneViewController;
