...
+ (id)roundedButtonWithText:(id)a0 color:(id)a1;
...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 style:(long long)a1 text:(id)a2;
