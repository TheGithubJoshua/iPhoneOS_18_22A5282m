...
- (BOOL)_shouldApplyImplicitLinksToMetadata:(id)a0;
...
- (BOOL)_applyImplicitLinkOnBundleIdentity:(id)a0 dataIdentity:(id)a1 matchingIdentifier:(id)a2 dataContainerClass:(unsigned long long)a3 userIdentity:(id)a4;
...
- (void)_applyImplicitLinksToMetadata:(id)a0;
- (id)_queue_containerClassCacheForContainerClassPath:(id)a0;
- (void)_checkAndRepairLinksToMetadata:(id)a0 recursively:(BOOL)a1;
