...
+ (id)detailTextForSuccessfulEnrollmentWithLocalizedDeviceClass:(id)a0 organizationName:(id)a1 organizationType:(long long)a2;
...
- (id)initSuccessfulEnrollmentInOrganizationName:(id)a0 organizationType:(long long)a1 localizedDeviceClass:(id)a2;
