...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 bundleIdentifier:(id)a1 icon:(id)a2 targetViewToBlur:(id)a3 initialIconScale:(double)a4;
