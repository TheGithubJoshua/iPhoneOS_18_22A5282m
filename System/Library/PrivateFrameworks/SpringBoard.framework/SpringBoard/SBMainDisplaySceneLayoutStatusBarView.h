@class UIView, NSString, UITapGestureRecognizer, _UIStatusBar, NSMutableDictionary, SBMedusaSettings, SBOrientationTransformWrapperView, NSMutableSet, UIStatusBar, UIColor;
