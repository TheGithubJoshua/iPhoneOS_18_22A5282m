@class NSHashTable, SBSystemApertureController, NSTimer, SBDeviceApplicationSceneHandle, SBSystemApertureSettings, NSString, NSMutableSet, UIStatusBarServer, SBWindowSceneStatusBarAssertionManager, SBSystemApertureStatusBarPillElement;
...
@property (nonatomic) unsigned long long currentStyleOverrides;
...
@property (nonatomic) unsigned long long resolvedOverrides;
...
- (BOOL)_managesDedicatedElementForOverride:(unsigned long long)a0;
