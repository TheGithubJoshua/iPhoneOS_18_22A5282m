@class SBIconModel, SBFloatingDockDefaults, SBApplicationController, SBRecentDisplayItemsDataStore, SBIconController, SBAppSuggestionManager, NSOrderedSet, SBIconListModel, SBRecentDisplayItemsDefaults, NSString, NSMutableOrderedSet, PTSingleTestRecipe, NSMutableSet, SBBestAppSuggestion, SBApplication, SBRecentDisplayItemsController;
...
- (id)initWithMaximumNumberOfSuggestions:(unsigned long long)a0 iconController:(id)a1 recentsController:(id)a2 recentsDataStore:(id)a3 recentsDefaults:(id)a4 floatingDockDefaults:(id)a5 appSuggestionManager:(id)a6 applicationController:(id)a7;
