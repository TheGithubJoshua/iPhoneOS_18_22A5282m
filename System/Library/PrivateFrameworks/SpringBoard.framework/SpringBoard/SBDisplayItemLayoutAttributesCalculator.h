@class SBSwitcherChamoisSettings, SBFluidSwitcherSheetMetricsCache, SBDisplayItemLayoutGrid, SBChamoisOverlappingController;
...
- (id)overlappingModelForAppLayout:(id)a0 containerOrientation:(long long)a1 chamoisLayoutAttributes:(id)a2 floatingDockHeight:(double)a3 screenScale:(double)a4 bounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a5 prefersStripHidden:(BOOL)a6 prefersDockHidden:(BOOL)a7;
- (id)_appLayoutByPerformingAutoLayoutIfNeededInAppLayout:(id)a0 containerOrientation:(long long)a1 chamoisLayoutAttributes:(id)a2 floatingDockHeight:(double)a3 screenScale:(double)a4 draggingItem:(id)a5 overlappingModelBeforeDragging:(id)a6 bounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a7 prefersStripHidden:(BOOL)a8 prefersDockHidden:(BOOL)a9;
...
- (id)appLayoutByDraggingItem:(id)a0 inAppLayout:(id)a1 containerOrientation:(long long)a2 chamoisLayoutAttributes:(id)a3 floatingDockHeight:(double)a4 screenScale:(double)a5 overlappingModelBeforeDragging:(id)a6 bounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a7 prefersStripHidden:(BOOL)a8 prefersDockHidden:(BOOL)a9;
