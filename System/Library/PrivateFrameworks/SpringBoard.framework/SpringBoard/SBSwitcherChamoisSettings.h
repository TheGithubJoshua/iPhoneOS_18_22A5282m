@class SBFFluidBehaviorSettings, SBSwitcherChamoisLayoutAttributes, SBDisplayItemLayoutGrid;
...
- (struct CGSize { double x0; double x1; })_minimumDefaultWindowSizeForContainerBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 stripWidth:(double)a1;
