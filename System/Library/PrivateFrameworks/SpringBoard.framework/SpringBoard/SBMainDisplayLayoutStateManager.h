...
- (id)_mostRecentAppLayoutForBundleIdentifier:(id)a0 ignoringUniqueIdentifiers:(id)a1 chamoisWindowingUIEnabled:(BOOL)a2;
- (id)_switcherControllerForDisplayIdentity:(id)a0;
- (id)_mostRecentAppLayoutMatchingAnyUniqueIdentifier:(id)a0 chamoisWindowingUIEnabled:(BOOL)a1;
