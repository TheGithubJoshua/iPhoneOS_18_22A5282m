@class SpringBoard, NSString, UIStatusBarServer, SBMainDisplaySceneManager, SBWindowSceneStatusBarAssertionManager, UIApplicationSceneSettingsDiffInspector, SBWindowSceneStatusBarManager;
