@class FBSDisplayIdentity, SBTelephonyManager, SBApplicationController, SBLocalDefaults, SBAssistantController, SBLockStateAggregator, SBRemoteTransientOverlaySessionManager, SBCommandTabController, SBAlertItemsController, SBConferenceManager, MCProfileConnection, SBLockScreenManager, SBSetupManager, SBBannerManager, SBMainWorkspace;
...
- (id)initWithDefaults:(id)a0 displayIdentity:(id)a1;
...
- (BOOL)_allowsCapabilityPosterSwitcherWithExplanation:(id *)a0;
