...
- (void).cxx_destruct;
- (id)description;
- (id)initFromMinAperture:(float)a0 maxAperture:(float)a1 aperture:(float)a2 portraitStrength:(float)a3 SDOFRenderingVersion:(unsigned long long)a4 depthVersionInfo:(struct { int x0; int x1; })a5;
