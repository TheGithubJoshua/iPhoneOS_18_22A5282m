...
@interface MagnifierSupport.ToggleButton : UIControl <_UIClickPresentationInteractionDelegate> {
    ...
    void /* unknown type, empty encoding */ peopleDetectionGlowSubscription;
    void /* unknown type, empty encoding */ doorDetectionGlowSubscription;
    void /* unknown type, empty encoding */ detectionModeGlowSubscription;
    void /* unknown type, empty encoding */ imageCaptionGlowSubscription;
    void /* unknown type, empty encoding */ focusLockGlowSubscription;
