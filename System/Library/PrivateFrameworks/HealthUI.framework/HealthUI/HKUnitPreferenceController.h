...
+ (id)_localizedHealthUIStringForDisplayType:(id)a0 unit:(id)a1 key:(id)a2 value:(id)a3;
+ (id)localizedUnitStringForObjectType:(id)a0 unit:(id)a1 value:(id)a2 wheelchairUse:(long long)a3;
...
- (id)unitForChartingDisplayType:(id)a0;
