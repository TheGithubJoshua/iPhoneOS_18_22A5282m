...
@interface HKCodableElectrocardiogramSample : PBCodable <NSCopying> {
    struct APPLE_129 { unsigned char algorithmVersionRawValue : 1; unsigned char classificationRawValue : 1; unsigned char privateSymptoms : 1; unsigned char symptomsStatusRawValue : 1; } _has;
}
