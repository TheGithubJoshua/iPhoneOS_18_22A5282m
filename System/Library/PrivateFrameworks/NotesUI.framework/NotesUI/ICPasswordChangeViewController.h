@class ICAccount, UIView, NSArray, ICScrollViewKeyboardResizer, UIBarButtonItem, NSString, ICPasswordUtilities, UITextField, NSLayoutConstraint, UILabel, UIScrollView;
