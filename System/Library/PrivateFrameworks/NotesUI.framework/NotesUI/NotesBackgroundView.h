...
- (void)setContentView:(id)a0 useSafeAreaLayoutGuide:(BOOL)a1;
- (void)setContentView:(id)a0 useSafeAreaLayoutGuide:(BOOL)a1 topMargin:(double)a2 bottomMargin:(double)a3 leadingMargin:(double)a4 trailingMargin:(double)a5;
