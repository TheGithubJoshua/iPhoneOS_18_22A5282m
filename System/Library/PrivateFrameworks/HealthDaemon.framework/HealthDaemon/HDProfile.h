@class HDPeriodicCountryMonitor, HDSharedSummaryManager, HDDataManager, HDCloudSyncManager, HDActivityCacheManager, HDFitnessMachineManager, HDCurrentActivitySummaryHelper, HDAppSubscriptionManager, HDDeviceManager, HDFeatureSettingsManager, HDDaemon, NSObject, HDAWDSubmissionManager, HDTinkerPrivacyAlertCoordinator, HDMigrationManager, NSMutableArray, HDAttachmentManager, HDSummarySharingEntryIDSManager, HDSourceManager, HDNanoSyncManager, HDWorkoutManager, HDUserDomainConceptManager, HDRestorableAlarmScheduler, HDOntologyConceptManager, HDSharingAuthorizationManager, HDConceptIndexManager, HDOntologyDatabase, HDUnitPreferencesManager, HDServiceConnectionManager, HDHealthRecordsAccountExistenceNotifier, HDSourceOrderManager, HDSyncIdentityManager, HDAuthorizationManager, HDNotificationManager, HDAgeGatingManager, HDDatabase, HDHealthServiceManager, HDAssertionManager, NSString, HDDaemonSyncEngine, HDMedicalIDDataManager, HKProfileIdentifier, HDMetadataManager, HDUserCharacteristicsManager, NSURL, HDWorkoutCondenser, NSDictionary, HKObserverSet, HDContributorManager, HDSummarySharingEntryManager, HDDataProvenanceManager, HDDataCollectionManager, HDBackgroundObservationServerExtensionManager, HDOnboardingCompletionManager;
