...
- (oneway void)_client_coordinatorDidCompleteSuccessfullyWithSeed:(id)a0 forRecordPromise:(id)a1;
...
- (oneway void)_client_coordinatorDidInstallPlaceholderWithSeed:(id)a0 forRecordPromise:(id)a1;
...
- (oneway void)_client_coordinatorShouldBeginPostProcessingWithSeed:(id)a0 forRecordPromise:(id)a1;
