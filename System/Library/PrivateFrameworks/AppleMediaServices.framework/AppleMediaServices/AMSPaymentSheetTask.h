@class _PaymentSheetState, NSDictionary, AMSFinancePaymentSheetResponse, AMSPurchaseInfo, NSString, PKPaymentAuthorizationController, AMSPaymentSheetRequest, NSObject, AMSPromise, AKAppleIDAuthenticationContext, NSMutableArray, AMSPaymentSheetAssetCache;
