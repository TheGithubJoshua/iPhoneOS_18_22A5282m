@class MFMailboxUid, NSMutableDictionary, NSDate, NSObject, MFMailMessageLibrary, ACAccount, MFLocalActionReplayHandler, MFWeakObjectCache, NSString, MFError, NSArray, MFLock, ECAccount;
...
@property (class, readonly) struct os_unfair_recursive_lock_s { struct os_unfair_lock_s { unsigned int x0; } x0; unsigned int x1; } *lock;
