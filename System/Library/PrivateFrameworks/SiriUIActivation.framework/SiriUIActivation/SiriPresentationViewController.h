@class NSMutableDictionary, AFQueue, FBSDisplayConfiguration, NSDate, BSServiceConnection, AFUISiriViewController, SiriPresentationStateProvider, SUICApplicationStateHelper, AFWatchdogTimer, SASUIDeviceScreenEngagementController, UINavigationController, AFRequestCompletionOptions, NSString, AFUISiriLanguage, UIScreen, NSTimer, NSObject, AFUISiriSetupViewController, NSArray, AFConnection;
...
- (void)_logDismissalToPowerLogWithReason:(unsigned long long)a0;
...
- (void)_setEngaementStatus:(id)a0 forType:(unsigned long long)a1;
...
- (void)dismissSiriViewController:(id)a0 withReason:(unsigned long long)a1;
