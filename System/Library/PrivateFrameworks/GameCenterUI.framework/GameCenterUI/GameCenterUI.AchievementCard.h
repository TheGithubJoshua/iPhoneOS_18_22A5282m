...
@interface GameCenterUI.AchievementCard : UIView {
    ...
    void /* unknown type, empty encoding */ $__lazy_storage_$_focusBackgroundView;
    void /* unknown type, empty encoding */ showsFocusedBackground;
    void /* unknown type, empty encoding */ allowsFocusing;
