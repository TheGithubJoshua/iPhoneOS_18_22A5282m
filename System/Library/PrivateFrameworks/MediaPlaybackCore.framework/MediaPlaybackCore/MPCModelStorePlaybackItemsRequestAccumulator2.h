@class NSMutableDictionary, MPMutableSectionedCollection, MPCModelStorePlaybackItemsRequest, MPCModelStorePlaybackItemsRequestAccumulation, ICURLAggregatedPerformanceMetrics, NSMutableArray, NSString, NSMutableOrderedSet, NSHashTable, MPPropertySet, MPLibraryObjectDatabase, MPServerObjectDatabase, NSError;
