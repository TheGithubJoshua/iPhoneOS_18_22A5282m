...
- (void)updateCrosshairLayer:(id)a0 center:(struct CGPoint { double x0; double x1; })a1 color:(id)a2 size:(struct CGSize { double x0; double x1; })a3 thickness:(struct CGSize { double x0; double x1; })a4;
...
- (void)updateFilledCircleLayer:(id)a0 center:(struct CGPoint { double x0; double x1; })a1 radius:(double)a2 fillColor:(id)a3;
