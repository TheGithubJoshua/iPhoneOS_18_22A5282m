...
@property (nonatomic) struct PVTransformInfo { void /* unknown type, empty encoding */ translation; struct { void /* unknown type, empty encoding */ vector; } rotation; void /* unknown type, empty encoding */ scale; void /* unknown type, empty encoding */ shear; } transformInfo;
