@class JFXPixelRotationSession, NSObject, JFXRemoteCommandServer, CFXThermalPolicyManager, UIView, CFXCameraControlsViewController, NSString, CFXEffectBrowserViewController, NSTimer, JFXThreadSafeDictionary, JFXMetadataValidator, CFXCaptureViewController, CFXStageManagerWarningViewController, CFXCameraStreamBufferQueue;
