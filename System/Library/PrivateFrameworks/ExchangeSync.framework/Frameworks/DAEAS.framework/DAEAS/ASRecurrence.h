...
- (void *)_newRecurrenceWithParentStartDate:(id)a0 useFloatingTimeForAllDayEvents:(BOOL)a1 account:(id)a2;
...
- (void)saveToCalendarWithParentASEvent:(id)a0 existingRecord:(void *)a1 shouldMergeProperties:(BOOL)a2 outMergeDidChooseLocalProperties:(BOOL *)a3 useFloatingTimeForAllDayEvents:(BOOL)a4 account:(id)a5;
