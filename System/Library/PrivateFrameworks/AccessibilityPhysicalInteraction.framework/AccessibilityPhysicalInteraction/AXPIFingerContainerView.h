@class NSArray, AXPIPinchChainView, UIView, NSMutableArray, _UILumaTrackingBackdropView;
...
- (void)_updateFingerModelViews:(BOOL)a0 startPointForAnimation:(struct CGPoint { double x0; double x1; })a1;
