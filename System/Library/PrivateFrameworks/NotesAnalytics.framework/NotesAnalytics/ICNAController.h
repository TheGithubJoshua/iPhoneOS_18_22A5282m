...
- (void)endWindowSceneSessionSynchronously:(BOOL)a0 forSessionType:(id)a1 windowScene:(id)a2;
- (void)endWindowSceneSessionSynchronously:(BOOL)a0 forSessionType:(id)a1 windowScene:(id)a2 successHandler:(id /* block */)a3;
