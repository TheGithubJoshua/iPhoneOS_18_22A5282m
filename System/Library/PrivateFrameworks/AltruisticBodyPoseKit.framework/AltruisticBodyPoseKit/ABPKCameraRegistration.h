...
@interface ABPKCameraRegistration : NSObject {
    double _tot_avg_err;
    struct BodyRegistration { struct BodyRegistrationInfo { int status; struct CameraPoseInfo { struct Matrix<double, 3U, 3U, false> { double m_data[9]; } camera_matrix; struct SE3GroupStorage<double, cva::Matrix<double, 4, 4, false>> { double m_data[16]; } transform; struct { void /* unknown type, empty encoding */ columns[4]; } pose; } camera_from_body; struct Correspondences2d3d { struct vector<cva::Matrix<double, 2, 1, false>, std::allocator<cva::Matrix<double, 2, 1, false>>> { void *__begin_; void *__end_; struct __compressed_pair<cva::Matrix<double, 2, 1, false> *, std::allocator<cva::Matrix<double, 2, 1, false>>> { void *__value_; } __end_cap_; } image_points; struct vector<cva::Matrix<double, 3, 1, false>, std::allocator<cva::Matrix<double, 3, 1, false>>> { void *__begin_; void *__end_; struct __compressed_pair<cva::Matrix<double, 3, 1, false> *, std::allocator<cva::Matrix<double, 3, 1, false>>> { void *__value_; } __end_cap_; } model_points; } correspondences; } m_last_result; } _body_registration;
