@class NSMutableDictionary, NSString, BSPlatform, NSSet, UNSNotificationCategoryRepository, UNSNotificationRepository, UNSBlueListMonitor, UNSAttachmentsService, NSObject, NSMutableSet, UNSPushRegistrationRepository, UNSNotificationServiceExtensionManager;
