...
+ (id)stringForDigest:(const void *)a0;
...
- (void)dataForDigest:(const void *)a0 queue:(id)a1 completion:(id /* block */)a2;
- (id)addNewDataForStorage:(id)a0 digest:(const void *)a1 filename:(id)a2;
...
- (id)dataForDigest:(const void *)a0;
- (id)dataForDigestImpl:(const void *)a0 accessorBlock:(id /* block */)a1;
- (id)dataForDigestImpl:(const void *)a0 skipDocumentResourcesLookup:(BOOL)a1 accessorBlock:(id /* block */)a2;
- (id)dataForExistingData:(id)a0 digest:(const void *)a1 filename:(id)a2 temporaryPath:(id)a3;
...
- (id)dataWithStorage:(id)a0 digest:(const void *)a1 filename:(id)a2 skipDocumentResourcesLookup:(BOOL)a3 accessorBlock:(id /* block */)a4;
- (id)dataWithTemporaryPath:(id)a0 digest:(const void *)a1 filename:(id)a2;
