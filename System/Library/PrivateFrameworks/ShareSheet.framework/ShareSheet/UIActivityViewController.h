@class NSString, NSArray, NSURL, NSSet, NSDictionary, UIActivity, UIViewController, LPLinkMetadata, NSNumber, NSUserDefaults;
@protocol UIActivityItemsConfigurationReading, SHSheetPresenter, UIActivityViewControllerObjectManipulationDelegate, UIActivityViewControllerPhotosDelegate, UIActivityViewControllerAirDropDelegate;
...
- (id)initWithActivityItems:(id)a0 applicationActivities:(id)a1 peopleSuggestionBundleIds:(id)a2;
