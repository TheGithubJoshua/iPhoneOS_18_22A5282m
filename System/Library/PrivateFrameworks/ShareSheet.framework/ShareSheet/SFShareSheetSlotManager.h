...
- (void)connectToDaemonWithSessionID:(id)a0 discoveryContext:(id)a1 assetIdentifiers:(id)a2 urlsBeingShared:(id)a3 shouldSuggestFamilyMembers:(id)a4 isSharePlayAvailable:(id)a5 peopleSuggestionBundleIds:(id)a6 completionHandler:(id /* block */)a7;
