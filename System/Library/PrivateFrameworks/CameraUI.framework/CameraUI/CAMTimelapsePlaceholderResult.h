...
- (void).cxx_destruct;
- (void)dealloc;
- (id)initWithAssetUUID:(id)a0 captureSession:(unsigned short)a1 creationDate:(id)a2 captureOrientation:(long long)a3 captureDevice:(long long)a4 videoDimensions:(struct CGSize { double x0; double x1; })a5 duration:(double)a6 previewImageSurface:(void *)a7 localPrivateMetadataFileURL:(id)a8;
