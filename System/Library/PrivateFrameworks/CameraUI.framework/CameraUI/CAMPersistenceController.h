...
- (BOOL)writePrivateMetadataFileToURL:(id)a0 withPrivateClientMetadata:(id)a1 sharedLibraryMode:(long long)a2 contactIDsInProximity:(id)a3 sharedLibraryDiagnostics:(id)a4;
...
- (struct __CFWriteStream { } *)_createOpenWriteStreamWithURL:(id)a0 forBurst:(BOOL)a1 error:(id *)a2;
...
- (id)_persistenceErrorForWriteStream:(struct __CFWriteStream { } *)a0 url:(id)a1 code:(long long)a2;
