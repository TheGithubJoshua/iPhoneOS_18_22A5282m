@class CAMInterfaceModulationView, CEKLightingControl, CAMPreviewAlignmentGuide, CAMPreviewView, CAMModeDial, NSMutableArray, CAMMaxRecordingTimeInstructionLabel, CAMZoomSlider, CAMModeIndicatorView, CAMControlDrawer, CAMDynamicShutterControl, CAMCreativeCameraButton, CAMLowLightInstructionLabel, CAMFlashCompromisedInstructionLabel, CAMTimerIndicatorView, CAMMachineReadableCodeButton, CAMFullscreenModeSelector, CEKLightingNameBadge, CAMPortraitModeInstructionLabel, UILongPressGestureRecognizer, CAMSemanticStylePicker, VKTextLiftingView, CAMFlipButton, CAMZoomControl, CAMAutoMacroButton, CAMImageWell, CAMSharedLibraryImageWellIndicatorView, CAMBadgeTray, CAMFullscreenViewfinderLayout, UIView, CAMFilterNameBadge, CAMPanoramaView, CAMImageAnalysisButton, CAMFreeResourcesInstructionLabel, CAMControlStatusBar, NSMutableDictionary, CAMAdditiveAnimator, NSString, CAMElapsedTimeView, AVSpatialOverCaptureVideoPreviewLayer, CAMViewfinderReticleView, CAMQRCodeInstructionLabel, CAMSharedLibraryBadge, CAMImageAnalysisInstructionLabel;
