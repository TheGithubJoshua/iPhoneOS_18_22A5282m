...
- (BOOL)configureForContinuousZoomWithZoomFactor:(double)a0 zoomPoints:(id)a1 animated:(BOOL)a2;
...
- (void)_configureForControlMode:(long long)a0 zoomFactor:(double)a1 zoomPoints:(id)a2 zoomFactors:(id)a3 displayZoomFactors:(id)a4 zoomButtonContentType:(long long)a5 compactPlatterLayout:(BOOL)a6 animated:(BOOL)a7;
