...
- (void).cxx_destruct;
- (id)initWithURL:(id)a0 filteredLocalDestinationURL:(id)a1 linkedURL:(id)a2 filteredLinkedURL:(id)a3 videoThumbnailPath:(id)a4 UUID:(id)a5 duration:(struct { long long x0; int x1; unsigned int x2; long long x3; })a6 dimensions:(struct { int x0; int x1; })a7 stillPersistenceUUID:(id)a8 stillDisplayTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a9 creationDate:(id)a10 adjustmentsData:(id)a11 coordinationInfo:(id)a12 localPrivateMetadataFileURL:(id)a13 error:(id)a14;
