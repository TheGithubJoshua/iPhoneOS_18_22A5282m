...
- (id)newDisplayTileTransformWithUserAffineTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a0 userInputOriginIdentifier:(id)a1;
