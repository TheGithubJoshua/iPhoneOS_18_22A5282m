@class NSMutableDictionary, PUPhotoPickerResizeTaskDescriptorViewModel, PUAssetExplorerReviewScreenAssetsDataSourceManager, PUReviewScreenSpec, PUBrowsingSession, PUJoiningMediaProvider, NSSet, NSString, PUAssetsDataSourceManager, UIAlertController, PUAssetExplorerReviewScreenActionManager, PUMediaProvider, PUActivityProgressController, NSNumber, PUReviewScreenBarsModel, PUAssetExplorerAnalytics, NSIndexPath;
