@class PKPaymentPass, PKAccountUser, NSSet, PKPhysicalCard, NSString, PKAccountService, PKAccount;
...
- (id)initWithAccountService:(id)a0 paymentPass:(id)a1 account:(id)a2 accountUser:(id)a3 physicalCards:(id)a4;
...
- (void)updateWithPhysicalCards:(id)a0;
