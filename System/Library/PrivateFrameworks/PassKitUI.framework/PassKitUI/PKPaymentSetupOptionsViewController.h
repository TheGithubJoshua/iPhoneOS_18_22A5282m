@class UIFont, NSString, PKPaymentSetupDockView, PKCollapsibleHeaderView, PKPaymentProvisioningController, PKPaymentSetupNoResultsView, OBPrivacyLinkController, UIActivityIndicatorView, PKPaymentSetupPrivacyLinkSectionController, _PKUIKVisibilityBackdropView, UIBarButtonItem, UIColor;
