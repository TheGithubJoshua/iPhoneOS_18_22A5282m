@class PKPeerPaymentController, UICollectionView, PKDashboardTransactionFetcher, CNAutocompleteResultsTableViewController, UIView, NSString, PKContactFormatValidator, PKDashboardTitleHeaderView, CNAutocompleteSearchManager, PKThumbnailCollectionViewCell, NSArray, CNComposeRecipientTextView, NSNumber, PKTransactionSourceCollection, PKContactResolver;
...
- (void)_showKeypadWithRecipient:(id)a0;
...
- (id)initWithTransactionSourceCollection:(id)a0;
