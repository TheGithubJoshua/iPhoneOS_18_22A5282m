@class NSURL, BSAction, PKPassBannerTrailingViewConfiguration, NSObject, PKPassBannerMinimalView, PLPlatterView, PKPassBannerTrailingView, UIFont, UILabel, UIView, UIColor, NSString, PKPassBannerLeadingView, PKPass;
