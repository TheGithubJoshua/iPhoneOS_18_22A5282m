@class PKCreditInstallmentPlan, PKMerchant, NSIndexPath, PKCurrencyAmount, PKPaymentTransactionGroup, PKWorldRegionUpdater, NSDateFormatter, NSString, PKTransactionSourceCollection, PKDashboardTransactionFetcher, NSCalendar, NSArray, PKFamilyMemberCollection, PKCoarseLocationMonitor, NSSet, PKAccountServiceAccountResolutionController, PKAccount, CNContact, PKTransactionReceipt, PKAccountUserCollection, PKPaymentTransaction, PKContactResolver;
