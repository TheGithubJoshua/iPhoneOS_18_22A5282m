@class PKPayLaterSetupFlowController, PKInboxDataSource, PKContactAvatarManager, NSMutableArray, NSString, PKPGSVSectionHeaderView, PKPeerPaymentAssociatedAccountsController, PKDiscoveryDataSource, NSTimer, PKPaymentService, NSArray, PKDiscoveryGalleryView, PKApplicationMessageView, PKPeerPaymentService, PKGroupsController, PKApplyController, PKAccountServiceAccountResolutionController, PKApplicationMessageNodeMultipleGroupBranch, PKPassGroupStackView, _PKUIKVisibilityBackdropView, UINavigationController, PKPeerPaymentAccountResolutionController;
...
- (void)_setupItemForExpressUpgradeWithAsset:(id)a0 hideDisableAction:(unsigned long long)a1 pass:(id)a2 completionHandler:(id /* block */)a3;
