@class NSMutableArray, NSString, NSMutableDictionary, ATThroughputCalculator, NSDictionary, NSMutableSet, NSObject, ATAssetLinkController, NSMutableOrderedSet, NSMapTable;
...
- (void)_handleFinishedAsset:(id)a0;
...
- (void)_handleUpdatedAsset:(id)a0;
