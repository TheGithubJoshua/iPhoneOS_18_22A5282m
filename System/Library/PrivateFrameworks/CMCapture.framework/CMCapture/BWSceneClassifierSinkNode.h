@class NSArray, BWInferenceResult, NSMutableDictionary, NSObject, BWFigVideoCaptureDevice;
...
@interface BWSceneClassifierSinkNode : BWSinkNode {
    ...
    struct BWSmartCameraScene { BOOL enabled; BOOL confident; float confidenceFilterRatio; float filteredConfidence; float confidenceThreshold; float confidenceHysteresisValueLag; short confidenceHysteresisTemporalLagBeforeConfident; short confidenceHysteresisTemporalLagBeforeNotConfident; short currentTemporalHysteresis; BOOL resetTemporalHysteresisAndFilteringOnNextUpdate; char *name; } _foodScene;
    struct BWSmartCameraScene { BOOL enabled; BOOL confident; float confidenceFilterRatio; float filteredConfidence; float confidenceThreshold; float confidenceHysteresisValueLag; short confidenceHysteresisTemporalLagBeforeConfident; short confidenceHysteresisTemporalLagBeforeNotConfident; short currentTemporalHysteresis; BOOL resetTemporalHysteresisAndFilteringOnNextUpdate; char *name; } _indoorScene;
    struct BWSmartCameraScene { BOOL enabled; BOOL confident; float confidenceFilterRatio; float filteredConfidence; float confidenceThreshold; float confidenceHysteresisValueLag; short confidenceHysteresisTemporalLagBeforeConfident; short confidenceHysteresisTemporalLagBeforeNotConfident; short currentTemporalHysteresis; BOOL resetTemporalHysteresisAndFilteringOnNextUpdate; char *name; } _outdoorScene;
    struct BWSmartCameraScene { BOOL enabled; BOOL confident; float confidenceFilterRatio; float filteredConfidence; float confidenceThreshold; float confidenceHysteresisValueLag; short confidenceHysteresisTemporalLagBeforeConfident; short confidenceHysteresisTemporalLagBeforeNotConfident; short currentTemporalHysteresis; BOOL resetTemporalHysteresisAndFilteringOnNextUpdate; char *name; } _sunsetScene;
    int _maxDebugOverlaySceneCount;
    BOOL _cameraDetectionEnabled10;
    struct os_unfair_lock_s { unsigned int _os_unfair_lock_opaque; } _detectionInfoLock;
    NSMutableDictionary *_detectionInfo;
    NSMutableDictionary *_tuningParametersByPortType;
    float _conf28;
    float _prob60;
    struct { double roll; double pitch; double yaw; } _pre_attitude;
...
- (id)initWithCaptureDevice:(id)a0 version:(struct { unsigned short x0; unsigned short x1; unsigned short x2; })a1 semanticStyleSceneDetectionEnabled:(BOOL)a2 cameraSettingEnabled:(BOOL)a3 sinkID:(id)a4;
- (void)dealloc;
