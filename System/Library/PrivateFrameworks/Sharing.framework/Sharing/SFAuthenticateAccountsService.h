@class SFAuthenticateAccountsServiceConfiguration, NSArray, SFService, SFDeviceOperationHandlerCDPSetup, SFSession, NSMutableArray, NSObject, HMDeviceSetupOperationHandler, ACAccountStore;
