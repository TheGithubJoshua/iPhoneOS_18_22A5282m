@class CUPairedPeer, HMRoom, HMHome, NSDictionary, ACAccount, NSObject, TROperationQueue, HMAccessory, NSString, HMHomeManager, TRSession, HMAccessoryBrowser, HMMediaSystem, HMDeviceSetupOperation;
