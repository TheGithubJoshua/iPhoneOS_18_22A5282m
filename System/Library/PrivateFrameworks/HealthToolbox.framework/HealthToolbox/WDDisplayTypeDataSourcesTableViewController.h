@class NSMutableDictionary, HKProfileStore, NSDictionary, HKDisplayCategory, HKHealthStore, NSMutableArray, HKTitledIconHeaderView, NSSet, NSMutableSet, HKAuthorizationStore, NSArray, HKDisplayType, WDSourceOrderController, WDProfile, HKSourceListDataSource;
...
- (id)_readerSourceCellForTableView:(id)a0 sourceArray:(id)a1 row:(unsigned long long)a2;
