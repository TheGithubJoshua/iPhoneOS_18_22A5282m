@class NSURL, BSAction, UITapGestureRecognizer, UIViewController, MPMediaControls, MRUActivityNowPlayingView, MRUWaveformViewController, UIView, NSString, MRUWaveformController, MSVTimer, UIColor, MRUNowPlayingController;
