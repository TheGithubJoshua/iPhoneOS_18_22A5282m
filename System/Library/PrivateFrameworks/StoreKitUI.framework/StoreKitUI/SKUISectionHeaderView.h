@class NSString, NSArray, NSMapTable, SKUIHeaderViewElement;
...
+ (id)_linesForViewElement:(id)a0 width:(double)a1 buttonSize:(struct CGSize { double x0; double x1; })a2 context:(id)a3;
