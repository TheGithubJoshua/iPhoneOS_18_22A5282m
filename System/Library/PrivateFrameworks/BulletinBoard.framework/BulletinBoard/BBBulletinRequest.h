@class BBSectionIcon, BBSound, NSDate, NSDictionary, NSTimeZone, BBAccessoryIcon, BBAttachmentMetadata, NSString, NSSet, BBContent, BBImage, NSArray, BBAction, BBCommunicationContext;
