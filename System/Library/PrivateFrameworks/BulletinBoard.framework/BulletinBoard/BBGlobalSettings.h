...
- (id)initWithContentPreviewSetting:(long long)a0 announceSetting:(long long)a1 announceHeadphonesSetting:(long long)a2 announceCarPlaySetting:(long long)a3 scheduledDeliverySetting:(long long)a4 scheduledDeliveryTimes:(id)a5 scheduledDeliveryShowNextSummarySetting:(long long)a6 notificationListDisplayStyleSetting:(long long)a7;
