...
- (int)extractParametersFromReferenceMetadata:(id)a0 auxiliaryMetadata:(id)a1 options:(id)a2 adaptiveCorrectionConfig:(struct AdaptiveCorrectionConfig { double x0; double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; int x9; double x10; double x11; double x12; BOOL x13; double x14; float x15; float x16; })a3 useReferenceFrame:(BOOL)a4;
