@class IdcContentPreservingWarping, NSString, NSArray, EdgeDrawingLineDetector, IntelligentDistortionCorrection_Utilities, NSDictionary, CMIExternalMemoryResource, FigMetalContext;
