...
@property (readonly, nonatomic) struct { float x0; float x1; float x2[8]; float x3[8]; } *gdcParameters;
...
+ (unsigned long long)getMetalFormat:(unsigned int)a0;
+ (BOOL)isVersatileRegroupedRawFormat:(unsigned int)a0;

- (id)init;
- (void).cxx_destruct;
- (void)dealloc;
- (int)_checkRgbTexConfig:(id)a0;
- (int)allocateAndDemosaic:(id)a0;
- (int)allocateRGB;
- (int)checkAndSetRgbTex:(id)a0;
- (int)commonInitWithMetalContext:(id)a0 cameraInfo:(id)a1 inputPixelBuffer:(struct __CVBuffer { } *)a2 metadata:(id)a3 uniqueFrameId:(int)a4;
- (int)commonInitWithMetalContext:(id)a0 cameraInfo:(id)a1 inputSamplebuffer:(struct opaqueCMSampleBuffer { } *)a2 uniqueFrameId:(int)a3;
- (int)demosaicWithStage:(id)a0;
- (int)getGDCParametersWithCameraInfoByPortType:(id)a0;
- (int)getGDCParametersWithCameraInfoByPortType:(id)a0 withMetadata:(id)a1;
- (int)initFrameProperties;
- (id)initWithMetalContext:(id)a0 cameraInfo:(id)a1 inputPixelBuffer:(struct __CVBuffer { } *)a2 metadata:(id)a3 uniqueFrameId:(int)a4;
- (id)initWithMetalContext:(id)a0 cameraInfo:(id)a1 inputSampleBuffer:(struct opaqueCMSampleBuffer { } *)a2 uniqueFrameId:(int)a3;
