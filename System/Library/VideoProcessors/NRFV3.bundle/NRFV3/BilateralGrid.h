...
- (id)allocGridTexture:(unsigned long long)a0 label:(id)a1;
...
- (int)setupWithConfig:(struct BilateralGridConfiguration { int x0; float x1; struct BilateralSolverConfiguration { float x0; float x1; float x2; float x3; } x2; } *)a0 width:(unsigned long long)a1 height:(unsigned long long)a2;
