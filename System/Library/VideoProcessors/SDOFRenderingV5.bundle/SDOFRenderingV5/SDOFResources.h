...
- (int)allocateResourcesUsingMetalContext:(id)a0 inputImageWidth:(unsigned long long)a1 inputImageHeight:(unsigned long long)a2 shiftMapWidth:(unsigned long long)a3 shiftMapHeight:(unsigned long long)a4 enableForegroundBlur:(BOOL)a5;
- (void)clearInstance;
