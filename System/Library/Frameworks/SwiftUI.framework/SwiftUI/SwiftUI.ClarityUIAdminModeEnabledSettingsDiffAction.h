@interface SwiftUI.ClarityUIAdminModeEnabledSettingsDiffAction : NSObject <_UISceneSettingsDiffAction> {
    void /* unknown type, empty encoding */ $__lazy_storage_$_diffInspector;
}
