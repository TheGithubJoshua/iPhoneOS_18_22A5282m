...
- (void)decrementRunningCountAndStopAudio:(BOOL)a0 stopHaptics:(BOOL)a1 entry:(struct shared_ptr<ClientEntry> { struct ClientEntry *x0; struct __shared_weak_count *x1; })a2;
...
- (void)incrementRunningCountForAudio:(BOOL)a0 haptics:(BOOL)a1 entry:(struct shared_ptr<ClientEntry> { struct ClientEntry *x0; struct __shared_weak_count *x1; })a2;
