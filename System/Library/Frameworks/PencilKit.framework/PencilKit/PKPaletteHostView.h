@class PKPaletteTransition, UILongPressGestureRecognizer, UITapGestureRecognizer, NSString, PKPalettePencilInteractionFeedbackHostView, UIView, PKPaletteView, PKPaletteTooltipPresentationHandle, UIPanGestureRecognizer, PKColorPicker, NSLayoutConstraint;
