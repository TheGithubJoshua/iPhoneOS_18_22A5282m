@class NSString, UICollectionViewDiffableDataSource, UICollectionView, NSObject, EFLocked;
...
- (id)initWithType:(long long)a0 shouldShowDeleteButton:(BOOL)a1;
- (id)initWithType:(long long)a0 shouldShowDeleteButton:(BOOL)a1 shouldDismissCommit:(BOOL)a2;
