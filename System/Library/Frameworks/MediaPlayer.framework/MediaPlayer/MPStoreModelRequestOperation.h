...
- (void)_executeURLLoadWithRequest:(id)a0 storeURLBag:(id)a1 requestContext:(id)a2;
- (void)_executeURLLoadWithRequests:(id)a0 storeURLBag:(id)a1 requestContext:(id)a2;
