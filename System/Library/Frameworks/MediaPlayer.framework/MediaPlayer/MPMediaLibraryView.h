...
- (struct shared_ptr<mlcore::QueryResult> { struct QueryResult *x0; struct __shared_weak_count *x1; })resultsForCoreQuery:(struct shared_ptr<mlcore::Query> { struct Query *x0; struct __shared_weak_count *x1; })a0 error:(id *)a1;
