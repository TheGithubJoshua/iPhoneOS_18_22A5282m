...
@protocol _SCNSceneCommandBufferStatusMonitor, MTLTexture, _SCNSceneRendererResourceManagerMonitor, MTLRenderCommandEncoder, SCNSceneRenderer, SCNSceneRendererDelegate, MTLDevice, OS_dispatch_queue, MTLCommandQueue;
...
- (struct CGImage { } *)_createSnapshotAtTime:(double)a0 withSize:(struct CGSize { double x0; double x1; })a1 antialiasingMode:(unsigned long long)a2 error:(id *)a3;
...
- (struct CGImage { } *)createSnapshot:(double)a0 error:(id *)a1;
...
- (void)renderAtTime:(double)a0 encoder:(id)a1 commandQueue:(id)a2 passDescriptor:(id)a3 viewPoints:(id)a4;
- (void)renderAtTime:(double)a0 encoder:(id)a1 commandQueue:(id)a2 passDescriptor:(id)a3 viewPoints:(id)a4 coordinateSpace:(unsigned long long)a5;
...
- (void)renderWithCommandBuffer:(id)a0 viewpoints:(id)a1 coordinateSpace:(unsigned long long)a2;
...
- (id)snapshotAtTime:(double)a0 withSize:(struct CGSize { double x0; double x1; })a1 antialiasingMode:(unsigned long long)a2 error:(id *)a3;
