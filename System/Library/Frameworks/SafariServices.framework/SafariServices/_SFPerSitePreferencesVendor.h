@class _SFAppInfoOverlayPreferenceManager, _SFGeolocationPermissionManager, WBSAutomaticReaderActivationManager, WBSLockdownModePreferenceManager, NSMutableDictionary, _SFContentBlockersPreferenceManager, _SFRequestDesktopSitePreferenceManager, _SFUserMediaPermissionController, _SFPageZoomPreferenceManager;
