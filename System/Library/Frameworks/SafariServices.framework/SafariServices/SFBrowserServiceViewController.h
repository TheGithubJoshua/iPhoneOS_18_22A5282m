@class NSDate, NSString, _SFWebViewUsageMonitor, NSTimer, _SFSafariViewControllerPrewarmingRequestThrottler, WKProcessPool, SFSystemAlert, WKWebsiteDataStore, SFBrowserPersonaAnalyticsHelper;
