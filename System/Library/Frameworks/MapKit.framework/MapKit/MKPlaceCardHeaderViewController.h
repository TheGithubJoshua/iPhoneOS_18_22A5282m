@class NSURL, _MKUILabel, _MKLocalizedHoursBuilder, _MKDataHeaderModel, MKPlaceSectionRowView, UIView, UILayoutGuide, NSString, _MKTokenAttributedString, NSLayoutConstraint, MKUGCCallToActionViewAppearance, NSArray, UIImageView;
