@class CNPhotoPickerActionsViewController, CNVisualIdentityEditablePrimaryAvatarViewController, CNContactStyle, NSArray, CNPhotoPickerProviderItem, CNPhotoPickerHeaderView, NSData, NSString, UICollectionView, CNVisualIdentity, CNPhotoPickerDataSource, CNAvatarEditingManager;
