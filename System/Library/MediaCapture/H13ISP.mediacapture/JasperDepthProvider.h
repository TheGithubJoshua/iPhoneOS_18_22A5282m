...
@interface JasperDepthProvider : NSObject <JDDepthProcessorDelegate> {
    ...
    struct H13ISPServicesRemote { id x0; id x1; void /* function */ *x2; void *x3; char *x4; } *_pRemote;
